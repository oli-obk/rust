...
pub fn b() {
    ...
    //[v0]~^^^^ ERROR symbol-name(_RMNvCsCRATE_HASH_1as0_1bINtB<REF>_4TypebE)
    ...
    //[v0]~^^^^ ERROR symbol-name(_RMs_NvCsCRATE_HASH_1as0_bINtB<REF>_4TypecE)
    ...
    //[v0]~^^^^ ERROR symbol-name(_RMs0_NvCsCRATE_HASH_1as0_bINtB<REF>_4TypeaE)
    //[v0]~| ERROR ::b::Type<i8>>)
    ...
    //[v0]~^^^^ ERROR symbol-name(_RMs1_NvCsCRATE_HASH_1as0_bINtB<REF>_4TypesE)
    //[v0]~| ERROR ::b::Type<i16>>)
    ...
    //[v0]~^^^^ ERROR symbol-name(_RMs2_NvCsCRATE_HASH_1as0_bINtB<REF>_4TypelE)
    //[v0]~| ERROR ::b::Type<i32>>)
    ...
    //[v0]~^^^^ ERROR symbol-name(_RMs3_NvCsCRATE_HASH_1as0_bINtB<REF>_4TypexE)
    //[v0]~| ERROR ::b::Type<i64>>)
    ...
    //[v0]~^^^^ ERROR symbol-name(_RMs4_NvCsCRATE_HASH_1as0_bINtB<REF>_4TypehE)
    //[v0]~| ERROR ::b::Type<u8>>)
    ...
    //[v0]~^^^^ ERROR symbol-name(_RMs5_NvCsCRATE_HASH_1as0_bINtB<REF>_4TypetE)
    //[v0]~| ERROR ::b::Type<u16>>)
    ...
    //[v0]~^^^^ ERROR symbol-name(_RMs6_NvCsCRATE_HASH_1as0_bINtB<REF>_4TypemE)
    //[v0]~| ERROR ::b::Type<u32>>)
    ...
    //[v0]~^^^^ ERROR symbol-name(_RMs7_NvCsCRATE_HASH_1as0_bINtB<REF>_4TypeyE)
    //[v0]~| ERROR ::b::Type<u64>>)
    ...
    //[v0]~^^^^ ERROR symbol-name(_RMs8_NvCsCRATE_HASH_1as0_bINtB<REF>_4TypeC3f16E)
    //[v0]~| ERROR ::b::Type<f16>>)
    ...
    //[v0]~^^^^ ERROR symbol-name(_RMs9_NvCsCRATE_HASH_1as0_bINtB<REF>_4TypefE)
    //[v0]~| ERROR ::b::Type<f32>>)
    ...
    //[v0]~^^^^ ERROR symbol-name(_RMsa_NvCsCRATE_HASH_1as0_bINtB<REF>_4TypedE)
    //[v0]~| ERROR ::b::Type<f64>>)
    ...
    //[v0]~^^^^ ERROR symbol-name(_RMsb_NvCsCRATE_HASH_1as0_bINtB<REF>_4TypeC4f128E)
    ...
    //[v0]~^^^^ ERROR symbol-name(_RMsc_NvCsCRATE_HASH_1as0_bINtB<REF>_4TypeeE)
    //[v0]~| ERROR ::b::Type<str>>)
    ...
    //[v0]~^^^^ ERROR symbol-name(_RMsd_NvCsCRATE_HASH_1as0_bINtB<REF>_4TypezE)
    //[v0]~| ERROR ::b::Type<!>>)
    ...
    //[legacy,verbose-legacy]~| ERROR demangling(a::b::Type<()>::
    //[legacy,verbose-legacy]~| ERROR demangling-alt(a::b::Type<()>)
    //[v0]~^^^^ ERROR symbol-name(_RMse_NvCsCRATE_HASH_1as0_bINtB<REF>_4TypeuE)
    //[v0]~| ERROR ::b::Type<()>>)
    //[v0]~| ERROR demangling-alt(<a::b::Type<()>>)
    impl Type<()> {}
    ...
    //[legacy,verbose-legacy]~| ERROR demangling(a::b::Type<(u8,)>::
    //[legacy,verbose-legacy]~| ERROR demangling-alt(a::b::Type<(u8,)>)
    //[v0]~^^^^ ERROR symbol-name(_RMsf_NvCsCRATE_HASH_1as0_bINtB<REF>_4TypeThEE)
    //[v0]~| ERROR ::b::Type<(u8,)>>)
    //[v0]~| ERROR demangling-alt(<a::b::Type<(u8,)>>)
    impl Type<(u8,)> {}
    ...
    //[v0]~^^^^ ERROR symbol-name(_RMsg_NvCsCRATE_HASH_1as0_bINtB<REF>_4TypeThtEE)
    ...
    //[v0]~^^^^ ERROR symbol-name(_RMsh_NvCsCRATE_HASH_1as0_bINtB<REF>_4TypeThtmEE)
    ...
    //[v0]~^^^^ ERROR symbol-name(_RMsi_NvCsCRATE_HASH_1as0_bINtB<REF>_4TypePhE)
    ...
    //[v0]~^^^^ ERROR symbol-name(_RMsj_NvCsCRATE_HASH_1as0_bINtB<REF>_4TypeOhE)
    ...
    //[legacy,verbose-legacy]~| ERROR demangling(a::b::Type<&str>::
    //[legacy,verbose-legacy]~| ERROR demangling-alt(a::b::Type<&str>)
    //[v0]~^^^^ ERROR symbol-name(_RMsk_NvCsCRATE_HASH_1as0_bINtB<REF>_4TypeReE)
    //[v0]~| ERROR ::b::Type<&str>>)
    //[v0]~| ERROR demangling-alt(<a::b::Type<&str>>)
    impl Type<&str> {}
    ...
    //[v0]~^^^^ ERROR symbol-name(_RMsl_NvCsCRATE_HASH_1as0_bINtB<REF>_4TypeQeE)
    ...
    //[v0]~^^^^ ERROR symbol-name(_RMsm_NvCsCRATE_HASH_1as0_bINtB<REF>_4TypeAhj0_E)
    ...
    //[v0]~^^^^ ERROR symbol-name(_RMsn_NvCsCRATE_HASH_1as0_bINtB<REF>_4TypeFEuE)
    //[v0]~| ERROR ::b::Type<fn()>>)
    ...
    //[v0]~^^^^ ERROR symbol-name(_RMso_NvCsCRATE_HASH_1as0_bINtB<REF>_4TypeFUKCEuE)
    ...
    //[v0]~^^^^ ERROR symbol-name(_RMsp_NvCsCRATE_HASH_1as0_bINtB<REF>_4TypeAppEB<REF>_)
    //[v0]~| ERROR ::b::Type<[_; _]>>)
    ...
    //[legacy,verbose-legacy]~| ERROR demangling(a::b::Type<[u8; 0]>::
    //[legacy,verbose-legacy]~| ERROR demangling-alt(a::b::Type<[u8; 0]>)
    //[v0]~^^^^ ERROR symbol-name(_RMsq_NvCsCRATE_HASH_1as0_bINtB<REF>_4TypeAhj0_E)
    //[v0]~| ERROR ::b::Type<[u8; 0usize]>>)
    //[v0]~| ERROR demangling-alt(<a::b::Type<[u8; 0]>>)
    impl Type<[u8; ZERO]> {}
}
