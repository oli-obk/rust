...
impl<I: Iterator> Fuse<I> {
    ...
    const IS_FUSED: bool = crate::intrinsics::type_id_vtable(
        crate::intrinsics::type_id::<I>(),
        crate::intrinsics::type_id::<dyn FusedIterator<Item = I::Item>>(),
    )
    .is_some();
}
